!function(e, t) {
    ...
    return function(n) {
        ...
        function s(e, t) {
            var o, n, r, s, i, a, l, c, d, h, u, f = t && t.split("/"), p = T.map, g = p && p["*"] || {};
            if (e && "." === e.charAt(0)) if (t) {
                for (f = f.slice(0, f.length - 1), e = e.split("/"), i = e.length - 1, T.nodeIdCompat && x.test(e[i]) && (e[i] = e[i].replace(x, "")), 
                e = f.concat(e), d = 0; d < e.length; d += 1) if (u = e[d], "." === u) e.splice(d, 1), 
                d -= 1; else if (".." === u) {
            ...
            if ((f || g) && p) {
                for (o = e.split("/"), d = o.length; d > 0; d -= 1) {
                    if (n = o.slice(0, d).join("/"), f) for (h = f.length; h > 0; h -= 1) if (r = p[f.slice(0, h).join("/")], 
                    r && (r = r[n])) {
                        s = r, a = d;
                        break;
                    }
        ...
        var u, f, p, g, m = {}, b = {}, T = {}, v = {}, y = Object.prototype.hasOwnProperty, k = [].slice, x = /\.js$/;
        p = function(e, t) {
            var o, n = d(e), r = n[0];
            return e = n[1], r && (r = s(r, t), o = c(r)), r ? e = o && o.normalize ? o.normalize(e, a(t)) : s(e, t) : (e = s(e, t), 
            n = d(e), r = n[0], e = n[1], r && (o = c(r))), {
                f: r ? r + "!" + e : e,
                n: e,
                pr: r,
                p: o
            ...
            var a, d, h, u, f, T, y = [], k = typeof o;
            if (s = s || e, "undefined" === k || "function" === k) {
                for (t = !t.length && o.length ? [ "require", "exports", "module" ] : t, f = 0; f < t.length; f += 1) if (u = p(t[f], s), 
                d = u.f, "require" === d) y[f] = g.require(e); else if ("exports" === d) y[f] = g.exports(e), 
                T = !0; else if ("module" === d) a = y[f] = g.module(e); else if (r(m, d) || r(b, d) || r(v, d)) y[f] = c(d); else {
        ...
        function i(e, t, i, f) {
            var p, g, m, b, T;
            if (t = r(t), i = s(i), p = n(e, t), l.hasOwnProperty(p)) f && f(l[p]); else if (c.hasOwnProperty(p)) f && c[p].push(f); else {
                ...
                g = m.join(""), u[p] = setTimeout(function() {
                    var e, t = h[p], o = c[p], n = o.length;
                    for (t.parentNode.removeChild(t), e = 0; n > e; e++) o[e]();
                    delete c[p];
                }, 5e3), T = a.createElement("script"), T.src = g, d.insertBefore(T, d.firstChild), 
                h[p] = T;
            }
        }
        var a = window.document, l = {}, c = {}, d = a.getElementsByTagName("head")[0], h = {}, u = {};
        ...
        function t(t) {
            ...
            r.y = e.pageYOffset || n.scrollTop || o.documentElement.scrollTop), r;
        }
        function o(e) {
            var t = e, o = {
                x: 0,
            ...
            if ("number" == typeof e.offsetLeft) {
                ...
                for (;t && t !== l && t !== a.documentElement; ) n.y += t.scrollTop || 0, n.x += t.scrollLeft || 0, 
                t = t.parentNode;
                o.x -= n.x, o.y -= n.y;
            }
            return o;
        ...
        "use strict";
        var o, n, r, s, i = [ "Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0" ], a = /^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im, l = /<body[^>]*>\s*([\s\S]+)\s*<\/body>/im, c = "undefined" != typeof location && location.href, d = c && location.protocol && location.protocol.replace(/\:/, ""), h = c && location.hostname, u = c && (location.port || void 0), f = {}, p = e.config && e.config() || {};
        return o = {
            version: "2.0.7",
            strip: function(e) {
                if (e) {
            ...
            parseName: function(e) {
                ...
                return -1 !== s && (!i || s > 1) ? (t = e.substring(0, s), o = e.substring(s + 1, e.length)) : t = e, 
                n = o || t, s = n.indexOf("!"), -1 !== s && (r = "strip" === n.substring(s + 1), 
                n = n.substring(0, s), o ? o = n : t = n), {
                    moduleName: t,
                    ext: o,
                    strip: r
                };
            ...
            load: function(e, t, n, r) {
                ...
                p.isBuild = r.isBuild;
                var s = o.parseName(e), i = s.moduleName + (s.ext ? "." + s.ext : ""), a = t.toUrl(i), l = p.useXhr || o.useXhr;
            ...
            writeFile: function(e, t, n, r, s) {
                var i = o.parseName(t), a = i.ext ? "." + i.ext : "", l = i.moduleName + a, c = n.toUrl(i.moduleName + a) + ".js";
        ...
        }, "node" === p.env || !p.env && "undefined" != typeof process && process.versions && process.versions.node ? (n = t.nodeRequire("fs"), 
        o.get = function(e, t, o) {
            ...
            var s, i = o.createXhr();
            if (i.open("GET", e, !0), r) for (s in r) r.hasOwnProperty(s) && i.setRequestHeader(s.toLowerCase(), r[s]);
            p.onXhr && p.onXhr(i, e), i.onreadystatechange = function(o) {
                var r, s;
                4 === i.readyState && (r = i.status, r > 399 && 600 > r ? (s = new Error(e + " HTTP status: " + r), 
                s.xhr = i, n(s)) : t(i.responseText), p.onXhrComplete && p.onXhrComplete(i, e));
            }, i.send(null);
            ...
            try {
                for (o = new java.lang.StringBuffer(), n = a.readLine(), n && n.length() && 65279 === n.charAt(0) && (n = n.substring(1)), 
                null !== n && o.append(n); null !== (n = a.readLine()); ) o.append(i), o.append(n);
                l = String(o.toString());
            } finally {
                a.close();
            }
        ...
        o.get = function(e, t) {
            ...
            try {
                ...
                o.init(a, 1, 0, !1), n = r["@mozilla.org/intl/converter-input-stream;1"].createInstance(s.nsIConverterInputStream), 
                n.init(o, "utf-8", o.available(), s.nsIConverterInputStream.DEFAULT_REPLACEMENT_CHARACTER), 
                n.readString(o.available(), i), n.close(), o.close(), t(i.value);
            } catch (l) {
        ...
        function l(e, t, o, n, r) {
            ...
            return s.x += n, s.x > e.width + e.x - o.tooltipEdgePadding && (s.x = e.width + e.x - o.tooltipOffsetX - o.tooltipEdgePadding), 
            s.x < 0 && (s.x = 0), s.y < e.y && (t.y + r + o.tooltipOffsetY > e.height + e.y ? s.y = e.y : s.y = t.y + o.tooltipOffsetY), 
            s.x -= n + 3, s.x < 0 && (s.x = 0), s;
        }
        function c(e, t, o) {
            var n, s, a = r.getBibleReader(o) + "/bible/", l = [];
            for (s in i) i.hasOwnProperty(s) && l.push(s + "=" + i[s]);
            return t = r.getVersion(t), n = [ a, t ? t + "/" : "", e.replace(/:/g, ".") ], l.length && n.push("?" + l.join("&")), 
        ...
        function f(r, i, a) {
            ...
            }), h = c(i.reference, i.version, i.bibleReader), u = {
                reference: "",
                version: "",
                content: "",
                footer: "",
            ...
            return r ? (u.content = r.content, u.footer = '<a class="' + o.classNames.tooltipMoreLink + '" href="' + h + '" target="_blank">' + s.tooltip.more + "</a>", 
            u.reference = r.reference, u.version = "(" + r.version + ")", a.socialSharing && a.socialSharing.length && (u.socialContent = l())) : (u.content = "<p>" + s.tooltip.errorBody + "</p>", 
            u.reference = s.tooltip.errorHeader), u;
        }
        function p(e, o, i) {
            var a, c, h, p, v = {
                tooltipOffsetX: 15,
            ...
            y && m(), c = u(i, {
                ...
                e.stopPropagation();
            }, !1), p = c.offsetHeight, t.document.body.appendChild(c), h = l(v.windowSize, v.elementLocation, v, c.offsetWidth, c.offsetHeight), 
            c = n.applyStyles(c, {
                position: "absolute",
                top: h.y + "px",
                left: h.x + "px",
                ...
                var t = f(e, o, i);
                c.innerHTML = d(t), c.offsetHeight > p && (h = l(v.windowSize, v.elementLocation, v, c.offsetWidth, c.offsetHeight), 
                c = n.applyStyles(c, {
                    top: h.y + "px",
                    left: h.x + "px"
                }));
        ...
        var T, v = null, y = null, k = a.replace("{{tooltipContainer}}", o.classNames.tooltipContainer).replace("{{tooltipHeader}}", o.classNames.tooltipHeader).replace("{{tooltipBody}}", o.classNames.tooltipBody).replace("{{tooltipFooter}}", o.classNames.tooltipFooter).replace("{{tooltipBrandLink}}", o.classNames.tooltipBrandLink).replace("{{tooltipMoreLink}}", o.classNames.tooltipMoreLink).replace("{{brandMessage}}", s.tooltip.brandMessage).replace("{{brandSite}}", e.brandSite);
        return {
            create: p,
            remove: g,
            cancelRemove: b,
        ...
        hslToRgb: function(e) {
            ...
            return 0 === l ? o = n = r = c : (s = .5 > c ? c * (1 + l) : c + l - c * l, i = 2 * c - s, 
            o = t(i, s, a + 1 / 3), n = t(i, s, a), r = t(i, s, a - 1 / 3)), {
                r: Math.round(255 * o),
                g: Math.round(255 * n),
                b: Math.round(255 * r)
            };
        ...
        return {
            loadCss: function(s, i) {
                ...
                function l(e) {
                    var t, o, n, r, s, i = [ "rtFaithlife", "rtFacebook", "rtTwitter" ], a = "";
                    for (t = 0, o = i.length; o > t; t++) for (n = 0; 2 > n; n++) r = 0 === n ? ":hover" : "", 
                    s = 19 * t * 4 + (e ? 38 : 0) + (r ? 19 : 0), a += ".rtTooltipSocialIcon#" + i[t] + r + "{background-position:0 -" + s + "px;}\n";
                    return a;
                }
                function c(t) {
                    function n(e) {
                    ...
                    return t.heading && (a = r(t.heading.backgroundColor), a && (l = o.hexToRgb(a), 
                    u = (l.r + l.g + l.b) / 3 < 170), d += s("." + e.classNames.tooltipHeader, t.heading, h)), 
                    t.body && (d += s("." + e.classNames.tooltipBody + ", ." + e.classNames.tooltipFooter, t.body, h.slice(1)), 
                    c = r(t.body.moreLink && t.body.moreLink.color), c && (d += s("." + e.classNames.tooltipMoreLink, t.body.moreLink, [ "color" ]), 
                ...
                i.cssOverride || 0 === window.location.hostname.toLowerCase().indexOf("theresurgence.com") || (h += n), 
                i.customStyle && (h += c(i.customStyle)), h += l(u || "dark" === i.tooltipStyle), 
                d.styleSheet ? d.styleSheet.cssText = h : d.innerHTML = h, a(), s.insertBefore(d, s.firstChild);
            }
        };
    }), o("util/version", {
        version: 2
        ...
        getSettingsOrDefaults: function(e, t) {
            var o, n = {};
            if (e = e || window.refTagger && window.refTagger.settings) for (o in t) t.hasOwnProperty(o) && (n[o] = void 0 !== e[o] ? e[o] : t[o]);
            return n;
        }
        ...
        function f() {
            ...
            if (n && (F.bibleVersion = n[1], F.addLogosLink = "true" === n[2]), null !== r) {
                for (e = M.getElementById("lbsVersion"), t = e.length, o = 0; t > o; o++) if (e.options[o].outerText === (F.bibleVersion || "default").toUpperCase()) {
                    e.selectedIndex = o;
                    break;
                }
        ...
        function p(e) {
            var o;
            for (e = e || t.event, o = e.target || e.srcElement; "a" !== o.tagName.toLowerCase(); ) o = o.parentNode;
            return o;
        }
        function g(e) {
            var t = p(e);
        ...
        function T(e, t, n, r) {
            var s;
            e = h(e), t = o.getVersion(t || F.bibleVersion), s = v(M.createElement("a"), e, t), 
            s.innerHTML = n, r.parentNode.insertBefore(s, r), F.addLogosLink && y(r, e.replace(/(\d)\s*(?:[a-z]|ff)(\W|$)|/g, "$1$2").replace(/\s+/g, "").replace(/[‒–—―]+/g, "-")), 
            O.referenceCount++;
        }
        function v(e, t, o) {
            return V.test(e.className) || (e.className += (e.className.length ? " " : "") + i.classNames.bibleRef), 
            e.href = n.generateLink(t, o, F.bibleReader), e.setAttribute("data-reference", t), 
            e.setAttribute("data-version", o), e.setAttribute("data-purpose", "bible-reference"), 
            F.linksOpenNewWindow && (e.target = "_blank"), F.useTooltip && (e.addEventListener ? (e.addEventListener("mouseover", m, !1), 
            e.addEventListener("mouseout", b, !1), e.addEventListener("touchstart", g, !1), 
            e.addEventListener("click", function(e) {
                z && e.target !== n.openTooltipAnchor && (e.preventDefault(), n.openTooltipAnchor || m.call(this, e));
            }, !1)) : e.attachEvent && (e.attachEvent("onmouseover", m), e.attachEvent("onmouseout", b))), 
            e;
        }
        function y(e, t) {
            var o, n, r = F.logosBibleVersion || F.libronixBibleVersion, s = H + "://www.logos.com/images/Corporate/LibronixLink_" + ("light" === (F.libronixLinkIcon || F.logosLinkIcon).toLowerCase() ? "light" : "dark") + ".png", i = c.createElement("img", {
                src: s,
                border: 0,
            ...
            t ? (n = "libronixdls:keylink|ref=[en]bible:" + t, r && "default" !== r.toLowerCase() && (n += "|res=LLS:" + r.toUpperCase()), 
            o = c.createElement("a", {
                href: n,
        ...
        function k(e, t, o, n, s, i, a) {
            var l, d, u, f, p, g, m, b, y, x, L, M = !1, N = 0, B = F.bibleVersion, P = null, J = r.abbreviations, A = J.length;
            return o && (u = w.exec(e), u && (l = o, d = u[3], b = l + " " + u[2], g = u[1], 
            p = e.substr(u.index + u[0].length))), n && !u && (u = E.exec(e), u && (l = o, d = n, 
            b = i ? l + " " + u[2] : l + " " + d + ":" + u[2], M = I.test(b), g = u[1], p = e.substr(u.index + u[0].length))), 
            !u && S.test(e) && (u = C.exec(e), u && (f = u.length, l = u[3], d = u[4 + A], b = u[2], 
            y = u.indexOf(l, 4) - 4, x = J[y], -1 !== R.indexOf(y) ? (d = 1, M = !1) : M = I.test(b), 
            g = e.substr(0, u.index) + u[1], p = e.substr(u.index + u[0].length), u[f - 1] && (P = u[f - 1], 
            B = P.replace(/\W/g, "")))), u ? (m = u[0].substr((u[1] || "").length), M && !F.tagChapters ? (c.insertTextNode(g + m, t), 
            N = k(p, t, null, null, B === F.bibleVersion ? null : B, !1)) : 155 >= d && (l = l || o, 
            x = x || l, L = x + b.substr(l.length), a ? (B = B || F.bibleVersion, v(a, h(L), B)) : (c.insertTextNode(g, t), 
            T(L, B, null === P ? u[2] : u[2] + P, t), N = k(p, t, l, d, B === F.bibleVersion ? null : B, M), 
            N += F.addLogosLink ? 3 : 2))) : e !== t.nodeValue && (e && s != e && c.insertTextNode(e, t), 
            t.parentNode.removeChild(t)), N;
        }
        function x(e, t, o) {
            var n, r, s, i, a, l, c, d = (e.tagName || "").toLowerCase(), u = e.className && e.className.split ? e.className.split(" ") : [], f = e.href && e.href.toLowerCase ? e.href.toLowerCase() : "", p = u.length, g = 0, m = !1, b = /^libronixdls:/i, S = 0, C = 0;
            if (o = o || 0, o > A) return 0;
            for (s = 0; p > s; s++) if (K.noSearchClasses.hasOwnProperty(u[s].toLowerCase())) return S;
            if (K.noSearchTags[d]) return S;
            if (3 === e.nodeType) return S = k(e.nodeValue, e, null, null, null, !1, t);
            if (t = null, "a" === d) {
                if (b.test(e.href)) !F.appendIconToLibLinks && !F.appendIconToLogosLinks || e.lastChild && e.lastChild.tagName && "img" === e.lastChild.tagName.toLowerCase() || y(e, null); else if (V.test(e.className)) i = e.getAttribute("data-reference"), 
                a = e.getAttribute("data-version"), i && v(e, h(i), a || F.bibleVersion); else if (/bibleref/i.test(e.className)) m = L(e, function(e, t, o) {
                    n = h(t), v(e, n, o);
                }); else if (F.convertHyperlinks && 1 === e.childNodes.length && 3 === e.firstChild.nodeType) for (F.hyperlinkTestList.length || (t = e), 
                l = F.hyperlinkTestList.length, c = 0; l > c; c++) if (-1 !== f.indexOf(F.hyperlinkTestList[c].toLowerCase())) {
                    t = e;
                    break;
                }
                if (null === t) return S;
            ...
            if (!m) for (r = e.childNodes; C > g || g < (C = r ? r.length : 0); ) g += x(r[g], t, o + 1) + 1;
            return S;
        }
        function L(e, t) {
            var o, n, r, s = !1;
            return O.markedBibleReferenceCount++, e.title && e.childNodes.length <= 1 && (o = /^([A-Z]{2,5})[\s:]/.exec(e.title), 
            o ? (r = e.title.replace(o[1], "").trim(), n = o[1]) : (r = e.title, n = F.bibleVersion), 
            t(e, r, n), s = !0), s;
        }
        var S, C, w, E, I, R, M = t.document, N = M.body, B = M.getElementsByTagName("head")[0], P = null, J = !1, A = 200, O = {
            referenceCount: 0,
            markedBibleReferenceCount: 0
        }, z = !1, H = "https:" === M.location.protocol ? "https" : "http", V = new RegExp(i.classNames.bibleRef, "i"), F = {}, K = {
            lbsSavePrefs: function() {
                var e = M.getElementById("lbsRefTaggerCP"), o = M.getElementById("lbsVersion"), n = M.getElementById("lbsUseLibronixLinks"), r = o ? o.value : "ESV", s = n ? !!n.checked : !1, i = new Date();
                if (!e) throw new Error("No Reftagger control panel found.");
                i.setFullYear(i.getFullYear() + 10), M.cookie = "lbsRefTaggerPrefs=" + r + "." + s + ";expires=" + i.toGMTString() + ";path=/", 
                t.location.reload();
            },
            Init: function(t, o) {
                var i, a, c, d;
                if (!K.Initialized || o) {
                    for (F = l.getSettingsOrDefaults(t, e.defaultSettings), M.addEventListener && M.addEventListener("touchstart", function(e) {
                        z = !0, !V.test(e.target.className) && n.isTooltipOpen() && n.reset();
                    }, !1), s.loadCss(B, F), f(), K.noSearchTags = {
                        textarea: !0,
                        input: !0,
                        script: !0
                    }, c = F.noSearchTagNames.length, i = 0; c > i; i++) d = F.noSearchTagNames[i], 
                    K.noSearchTags[d] = !0;
                    for (K.noSearchClasses = [], a = F.noSearchClassNames.length, i = 0; a > i; i++) K.noSearchClasses[F.noSearchClassNames[i].toLowerCase()] = !0;
                    S = new RegExp(r.referenceQuickTest, "i"), C = new RegExp(r.referenceRegExp, F.caseInsensitive ? "i" : ""), 
                    w = new RegExp(r.bookContinuationRegExp), E = new RegExp(r.chapterContinuationRegExp, F.caseInsensitive ? "i" : ""), 
                    I = new RegExp(r.chapterReferenceRegExp, "i"), R = r.singleChapterIndexes, K.Initialized = !0;
                }
            },
            tag: function(e) {
                F.addLogosLink = F.addLogosLink || F.addLibronixDLSLink, K.Initialized || K.Init(), 
                x(e || F.rootNode || N), J || (u(), J = !0);
            }
        };
        return K.init = K.Init, K.regexes = r, t.refTagger && t.refTagger.settings && t.refTagger.settings.tagAutomatically !== !1 && K.tag(), 
        K;
    }), t("main");
});